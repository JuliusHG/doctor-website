    ...
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h3 className="text-dw-darker text-3xl uppercase font-semibold mb-4">{testimonialsContent.sectionTitle}</h3>
          <h2 className="text-dw-dark text-6xl md:text-5xl font-bold">{testimonialsContent.sectionDescription}</h2>
        </div>
  ...
  return (
    <div className="px-8">
      <div className="relative" style={{ height: "280px" }}>
        <div className="absolute bg-dw-dark rounded-lg left-[-10px] w-1/2 h-[320px] top-1/2 -translate-y-1/2 z-0" />
        <div className="absolute bg-dw-dark rounded-lg right-0 w-4/5 h-[150px] top-1/2 -translate-y-1/2 z-0" />
        <div
        ...
        >
          <div className="flex items-start gap-4 mb-3">
            <div className="flex-grow">
              ...
              <p className="text-gray-600 text-sm text-dw-soft">Paciente verificado</p>
            </div>
