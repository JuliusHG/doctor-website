/**
 * @section-description TAB version of Diseases-cleener.tsx. It calls the SectionHeaderSwitches component to switch between sections.
 */

//TAB version of Diseases-cleener.tsx
...
import ServicesSection from "../Services/Services-cleener-tab"
...
const DiseasesSection: React.FC = () => {
  ...
  const [currentSection, setCurrentSection] = useState<"diseases" | "services">("diseases")
  ...
  const displayedDiseases = content.diseasesDataMetadata.diseases.slice(5, 11)
  ...
  return (
    <div className="w-full py-24 bg-white">
      <div className="container mx-auto px-4 max-w-6xl">
        <SectionHeader
          sectionTitle={content.diseasesSection.sectionTitle}
          sectionSubtitle={content.diseasesSection.sectionSubtitle}
          sectionText={content.diseasesSection.sectionText}
